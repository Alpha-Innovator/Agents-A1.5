...
3. Write a comprehensive research report as `report/report.md`
   ...
   - **You MUST include figures in your report.** Generate plots, charts, and visualizations
   - Save all report figures to `report/images/` and reference them using relative paths
